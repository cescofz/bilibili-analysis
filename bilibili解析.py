...
if admin():#管理员执行
    print("************************************************************")
    print("************************************************************")
    print("此项目为开源项目，未经允许，不得用于商业用途")
    print("作者：Li Jiashu")
    print("项目已在GitHub开源，仓库链接:https://github.com/cescofz/bilibili-analysis")
    print("ffmpeg合成音视频功能开发中")
    print("************************************************************")
    print("************************************************************")
    ...
    if a == 1:
        ...
        def download_video(old_video_url, video_url, audio_url, video_name):
            ...
            # output_video = f"合成 {video_name}.mp4"
            ...
            #     if file_name == f"合成{video_name}.mp4":
